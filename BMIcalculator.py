...
# Bottom box
tkinter.Label(root, width=72, height=18, bg="white").pack(side="bottom")
...
def slider_c(event):
    ...
    img = (Image.open("BMI calculator\man.png"))
...
label = tkinter.Label(root, font=("arial", 30, "bold"), bg="white", fg="black")
label.place(x=300, y=450)

# Label widget for showing message
label1 = tkinter.Label(root, font=("arial", 10, "bold"), bg="white", fg="black", width=15)
